...
export function RegisterRoutes(app: express.Router) {
    ...
    // ###########################################################################################################
        app.get('/transcripts',
            ...
            ...(fetchMiddlewares<RequestHandler>(TranscriptsController.prototype.getAll)),

            function TranscriptsController_getAll(request: any, response: any, next: any) {
            const args = {
            };
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.get('/transcripts/:studentID',
            ...(fetchMiddlewares<RequestHandler>(TranscriptsController)),
            ...(fetchMiddlewares<RequestHandler>(TranscriptsController.prototype.getTranscript)),

            function TranscriptsController_getTranscript(request: any, response: any, next: any) {
            const args = {
            ...
            try {
              ...
              const promise = controller.getTranscript.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, undefined, next);
            } catch (err) {
                return next(err);
            }
        ...
        app.post('/transcripts',
            ...(fetchMiddlewares<RequestHandler>(TranscriptsController)),
            ...(fetchMiddlewares<RequestHandler>(TranscriptsController.prototype.addStudent)),

            function TranscriptsController_addStudent(request: any, response: any, next: any) {
            const args = {
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.post('/transcripts/:studentID/:courseNumber',
            ...(fetchMiddlewares<RequestHandler>(TranscriptsController)),
            ...(fetchMiddlewares<RequestHandler>(TranscriptsController.prototype.addGrade)),

            function TranscriptsController_addGrade(request: any, response: any, next: any) {
            const args = {
                    studentID: {"in":"path","name":"studentID","required":true,"ref":"db.StudentID"},
            ...
            try {
              ...
              const promise = controller.addGrade.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, undefined, next);
            } catch (err) {
                return next(err);
            }
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.get('/transcripts/:studentID/:courseNumber',
            ...(fetchMiddlewares<RequestHandler>(TranscriptsController)),
            ...(fetchMiddlewares<RequestHandler>(TranscriptsController.prototype.getGrade)),

            function TranscriptsController_getGrade(request: any, response: any, next: any) {
            const args = {
                    studentID: {"in":"path","name":"studentID","required":true,"ref":"db.StudentID"},
                    courseNumber: {"in":"path","name":"courseNumber","required":true,"ref":"db.Course"},
            };
